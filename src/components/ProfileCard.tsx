...
export const ProfileCard: React.FC<ProfileCardProps> = ({ profile }) => {
  ...
  return (
    <div
      ...
      className="relative w-full rounded-[26px] liquid-glass-card p-6 sm:p-7 overflow-hidden transition-all duration-500 group"
    >
      ...
      <div className="flex items-start gap-4 mb-6 relative z-10">
        ...
        <div className="flex flex-col text-left flex-1 min-w-0">
          ...
          <div className="inline-block mt-0.5">
            <span className="text-[11px] font-semibold tracking-wide text-silver-300 uppercase px-2 py-0.5 rounded-md bg-white/[0.05] border border-white/10">
              {profile.role}
            </span>
          </div>
      ...
      <div className="flex flex-col gap-3 relative z-10">
        ...
        {profile.links.linkedin && (
          <a
            ...
            className="group/btn relative flex items-center justify-between w-full px-4.5 py-3.5 rounded-xl liquid-glass-btn shimmer-effect text-left select-none focus:outline-none focus:ring-2 focus:ring-white/30"
          >
            <div className="flex flex-col gap-0.5 z-10">
              <span className="text-sm font-semibold text-white tracking-tight">
                LinkedIn
              </span>
              <span className="text-[11px] text-silver-400 group-hover/btn:text-silver-300 transition-colors">
                Connect with {profile.name}
              </span>
            </div>
            <div className="flex items-center gap-2 z-10">
              <div className="p-1.5 rounded-lg bg-white/[0.04] border border-white/10 group-hover/btn:border-white/20 group-hover/btn:bg-white/[0.08] transition-all">
              ...
              <ArrowUpRight className="w-3.5 h-3.5 text-silver-500 group-hover/btn:text-white group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-all" />
            </div>
          </a>
        )}
        ...
        {profile.links.discord && (
          ...
          >
            ...
            <div className="flex items-center gap-2 z-10">
              ...
              <ArrowUpRight className="w-3.5 h-3.5 text-silver-500 group-hover/btn:text-white group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-al